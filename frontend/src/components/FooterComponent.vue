    ...
    <div class="box-container">
      <div class="box">
        ...
        <router-link @click="scrollToTop()" to="/menu"
          ><i class="fas fa-arrow-right"></i> paneer</router-link
        >
        <router-link @click="scrollToTop()" to="/menu"
          ><i class="fas fa-arrow-right"></i>chinese</router-link
        >
        <router-link @click="scrollToTop()" to="/menu"
          ><i class="fas fa-arrow-right"></i> indian</router-link
        >
        <router-link @click="scrollToTop()" to="/menu"
          ><i class="fas fa-arrow-right"></i>roti
        </router-link>
        <router-link @click="scrollToTop()" to="/menu"
          ><i class="fas fa-arrow-right"></i> rice</router-link
        >
        <router-link @click="scrollToTop()" to="/menu"
      ...
      <div class="box">
        <h3>opening hours</h3>
        <p>everyday : 11:00am to 12:00am</p>
      </div>
    </div>
