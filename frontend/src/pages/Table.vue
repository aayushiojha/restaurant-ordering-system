  ...
  <section class="order-section">
    ...
    <div class="icons-container">
      ...
      <div class="icons">
        ...
        <h3>
          varanasi-lucknow highway , kayastha patti, near PremSadhna Palace
          raniganj, pratapgarh
        </h3>
      </div>
    </div>
    ...
    >
      ...
      <div class="row">
        ...
        <div class="input-box">
          <iframe
            class="map"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d459298.69424768735!2d81.69613232035502!3d25.926323498278524!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x399abd0066ce1515%3A0x3c8529d7ce8d3d26!2sYash%20Restaurant!5e0!3m2!1sen!2sin!4v1735306135889!5m2!1sen!2sin"
            loading="lazy"
          ></iframe>
        </div>
      </div>
    ...
    checkForm: function () {
      ...
      if (!this.orderObj.phone) {
        ...
        if (this.orderObj.phone.length != 12) {
          this.errorObj.phoneErr.push(
            "Phone numbers must have exactly 12 digits"
          );
        }
      }
      ...
      if (!this.orderObj.when) {
        ...
        if (dateInput.getHours() < 7 || dateInput.getHours() > 22) {
          this.errorObj.whenErr.push(
            "Store open from 11:00 AM to 12:00 AM everyday"
          );
        }
      }
    },
