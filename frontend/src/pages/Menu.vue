      ...
      <div class="col-sm-8">
        <div class="row">
          <div class="menu-tabs">
            ...
            <input
              type="button"
              id="mushroomFilterFoodBtn"
              name="mushroomFilterFoodBtn"
              class="menu-tab-item"
              value="mushroom"
              @click="filterFoodBtn($event)"
            />
            ...
            <input
              type="button"
              id="snacksFilterFoodBtn"
              name="snacksFilterFoodBtn"
              class="menu-tab-item"
              value="snacks"
              @click="filterFoodBtn($event)"
            />
            <input
              type="button"
              id="riceFilterFoodBtn"
              name="riceFilterFoodBtn"
              class="menu-tab-item"
              value="rice"
              @click="filterFoodBtn($event)"
            />
            <input
              type="button"
              id="rotiFilterFoodBtn"
              name="rotiFilterFoodBtn"
              class="menu-tab-item"
              value="roti"
              @click="filterFoodBtn($event)"
            />
...
export default {
  ...
  methods: {
    ...
    checkNew: function (food, statusArray) {
      if (statusArray.includes("normal")) {
        if (food.food_status.includes("normal")) {
          return true;
        } else {
          return false;
        }
